...
public class Dijsktra {
    ...
    public static void main(String[] args) {
        Dijsktra dijsktra0=new Dijsktra(6);
        dijsktra0.addEdge(0, 1, 10);
        dijsktra0.addEdge(0, 4, 15);
        dijsktra0.addEdge(1, 3, 2);
        dijsktra0.addEdge(1, 2, 15);
        dijsktra0.addEdge(3,2,1);
        dijsktra0.addEdge(3, 5, 12);
        dijsktra0.addEdge(2, 5, 5);
        dijsktra0.addEdge(4, 5, 10);
        dijsktra0.dijkstra(0,5);
    }
}
